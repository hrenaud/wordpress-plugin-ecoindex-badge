...
= Combien de mesure puis-je réaliser par jour ? =
Vous pouvez faire 10 mesures par jour, par site.

== Changelog ==

A retrouver ici : https://github.com/hrenaud/wordpress-plugin-ecoindex-badge/blob/master/CHANGELOG.md
...
1. Badge dans les pages
2. Badge dans la liste des articles
3. Badge dans la liste des pages
4. Page de configuration de l'extension